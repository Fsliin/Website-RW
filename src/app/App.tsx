...
function Hero() {
  return (
    <section id="beranda" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-foreground">
      <img
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-5 text-center">
        ...
        <h1 className="text-white font-extrabold leading-tight mb-6" style={{ fontSize: "clamp(2.25rem, 6vw, 4rem)", lineHeight: 1.15 }}>
          Selamat Datang di<br />
          <span className="text-transparent bg-clip-text" style={{ backgroundImage: "linear-gradient(135deg, #4dd8cb 0%, #a8f0ea 100%)" }}>
            RW 04
          </span>
        </h1>
      ...
      <div className="max-w-6xl mx-auto px-5">
        <div className="grid md:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <h2 className="text-foreground font-extrabold mb-5" style={{ fontSize: "clamp(1.75rem, 4vw, 2.5rem)", lineHeight: 1.2 }}>
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              Every warga berhak mengetahui pengelolaan dana secara terbuka. Laporan keuangan dipublikasikan setiap bulan agar tercipta kepercayaan dan akuntabilitas bersama, dan informasi kegiatan yang akan datang.
            </p>
    ...
    <section id="galeri" className="py-20 bg-muted">
      <div className="max-w-6xl mx-auto px-5">
        <div className="text-center mb-12">
          ...
          <h2 className="text-foreground font-extrabold" style={{ fontSize: "clamp(1.75rem, 4vw, 2.5rem)", lineHeight: 1.2 }}>
        ...
        <div className="columns-1 sm:columns-2 md:columns-3 gap-4 space-y-4 [column-fill:_balance] w-full">
          {galleryItems.map((item) => (
            <div
              key={item.label}
              className="break-inside-avoid relative overflow-hidden rounded-2xl cursor-pointer group bg-muted mb-4 inline-block w-full shadow-sm hover:shadow-md transition-all duration-300"
              onClick={() => setActive(active === item.url ? null : item.url)}
            >
              <img src={item.url} alt={item.alt} className="w-full h-auto object-cover transition-transform duration-500 group-hover:scale-105" />
      ...
      {active && (
        <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4 backdrop-blur-sm" onClick={() => setActive(null)}>
